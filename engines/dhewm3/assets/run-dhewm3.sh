...
if ! [[ -z "${LUX_STEAM_DECK}" ]]; then
    if [ ! -f ~/.config/dhewm3/base/dhewm.cfg ]; then
        ...
        echo -e "seta r_customHeight \"1080\"" >> ~/.config/dhewm3/base/dhewm.cfg
        echo -e "seta r_customWidth \"2560\"" >> ~/.config/dhewm3/base/dhewm.cfg
    fi
    ...
    if [ ! -f ~/.config/dhewm3/d3xp/dhewm.cfg ]; then
        ...
        echo -e "seta r_customHeight \"1080\"" >> ~/.config/dhewm3/d3xp/dhewm.cfg
        echo -e "seta r_customWidth \"2560\"" >> ~/.config/dhewm3/d3xp/dhewm.cfg
    fi
fi
