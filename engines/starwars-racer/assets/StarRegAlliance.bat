...
set "K=HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\lucasarts entertainment company llc\X-Wing Alliance\v1.0"
...
reg.exe add "%K%" /v "executable"   /t REG_SZ    /d "%INSTALLDIR%\alliance.exe" /f
